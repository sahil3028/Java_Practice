...
//        l1.add("d"); --> we cant us this beacuse array is immutable but we cn use this in array list
        ...
        var groArray= gro.toArray(new String[9]);// here if the length of array we pass has more element than the list than anyway the whole list will be passed but if the length is more than the list than the rest of the array will be filled with default values
